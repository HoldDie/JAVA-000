...
import com.holddie.rpc.api.RpcfxResolver;
import com.holddie.rpc.api.RpcfxResponse;
import com.holddie.rpc.api.ServiceProviderDesc;
import com.holddie.rpc.api.UserService;
import com.holddie.rpc.server.RpcfxInvoker;
...
public class RpcfxServerApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		String userService = "com.holddie.rpc.api.UserService";
		registerService(client, userService);
		String orderService = "com.holddie.rpc.api.OrderService";
	...
	// annotation
	@Bean(name = "com.holddie.rpc.api.UserService")
	public UserService createUserService() {
		return new UserServiceImpl();
	}

	@Bean(name = "com.holddie.rpc.api.OrderService")
